...
//                   />
//                   <label
//                     className={`font-medium flex items-center gap-1 text-sm/4 text-dark-green text-left px-5 ${
//                       !isExit ? "text-dark-green" : "text-red-500"
//                     }`}
//                   >
//                     {Name}
//                     {isExit ? (
...
//                       <X
//                         size={30}
//                         className="text-red-500 fill-red-green"
//                         strokeWidth={1.5}
//                       />
//                     )}
//                   </label>
